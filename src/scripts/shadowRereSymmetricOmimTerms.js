...
const DEFAULTS = Object.freeze({
  ...
  outputMd:
    '/Users/ahmedelmorshedy/Genovy-phenotype-enrichment-20260316-0914/output/shadow-rere-symmetric-omim-terms-20260326.md',
  limit: 2000
});

const TARGET_CASES = Object.freeze(['PMID_29330883_Subject9.json']);
const PRESENT_STATUS = 'present';
const DIRECT_EDGE_ORIGIN = 'direct';

const SCENARIOS = Object.freeze([
  {
    id: 'omim_literal_rere_med13',
    label: 'RERE / MED13 Symmetric OMIM Terms',
    description:
      'Add only literal OMIM-backed terms from the RERE and MED13 clinical synopsis pages. The truth and outranker both receive source-backed additions if the term is in OMIM and currently absent from the live direct disease profile.',
    sourceNote:
      'RERE gains broad eyebrow, downslanted palpebral fissures, micrognathia, and short stature. MED13 gains synophrys, wide mouth, ADHD, strabismus, nystagmus, expressive language delay, and speech apraxia.',
    diseaseTerms: {
      'MONDO:0014857': ['HP:0011229', 'HP:0000494', 'HP:0000347', 'HP:0004322'],
      'MONDO:0032485': ['HP:0000664', 'HP:0000154', 'HP:0007018', 'HP:0000486', 'HP:0000639', 'HP:0002474', 'HP:0011098']
    }
  }
]);
