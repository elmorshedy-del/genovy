...
const DEFAULTS = Object.freeze({
  ...
  outputMd:
    '/Users/ahmedelmorshedy/Genovy-phenotype-enrichment-20260316-0914/output/shadow-setd2-symmetric-source-terms-20260326.md',
  limit: 2000
});

const TARGET_CASES = Object.freeze(['PMID_33766796_16.json']);
const PRESENT_STATUS = 'present';
const DIRECT_EDGE_ORIGIN = 'direct';

const SCENARIOS = Object.freeze([
  {
    id: 'omim_gene_reviews_setd2_tcf20',
    label: 'OMIM And GeneReviews/Primary Literal Terms',
    description:
      'Add the exact source-backed packet terms that OMIM and GeneReviews support for Luscan-Lumish syndrome, plus the matching exact terms already supported by the TCF20 syndrome literature.',
    sourceNote:
      'SETD2 gains macrocephaly, motor delay, and accelerated skeletal maturation from OMIM 616831 and GeneReviews NBK575927. TCF20 gains motor delay and accelerated skeletal maturation from OMIM 618430 and PMID:27436265; macrocephaly, delayed speech, and aggressive behavior are already carried in the live branch.',
    diseaseTerms: {
      'MONDO:0014791': [
        { curie: 'HP:0000256', referenceText: 'OMIM:616831 / GeneReviews:NBK575927' },
        { curie: 'HP:0001270', referenceText: 'OMIM:616831 / GeneReviews:NBK575927' },
        { curie: 'HP:0005616', referenceText: 'OMIM:616831 / GeneReviews:NBK575927' },
        { curie: 'HP:0000750', referenceText: 'OMIM:616831 / GeneReviews:NBK575927' },
        { curie: 'HP:0000718', referenceText: 'OMIM:616831 / GeneReviews:NBK575927' }
      ],
      'MONDO:0032745': [
        { curie: 'HP:0000256', referenceText: 'OMIM:618430' },
        { curie: 'HP:0001270', referenceText: 'OMIM:618430' },
        { curie: 'HP:0005616', referenceText: 'PMID:27436265' },
        { curie: 'HP:0000750', referenceText: 'OMIM:618430' },
        { curie: 'HP:0000718', referenceText: 'OMIM:618430' }
      ]
    }
  }
]);
...
function renderMarkdownReport(report) {
  const lines = [];
  lines.push('# SETD2 Symmetric Source Shadow');
  lines.push('');
