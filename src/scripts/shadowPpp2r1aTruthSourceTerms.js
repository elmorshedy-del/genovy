...
const DEFAULTS = Object.freeze({
  ...
  outputMd:
    '/Users/ahmedelmorshedy/Genovy-phenotype-enrichment-20260316-0914/output/shadow-ppp2r1a-truth-source-terms-20260327.md',
  limit: 2000
});

const TARGET_CASES = Object.freeze(['PMID_37761890_41.json', 'PMID_37761890_43.json']);
const PRESENT_STATUS = 'present';
const DIRECT_EDGE_ORIGIN = 'direct';

const SCENARIOS = Object.freeze([
  {
    id: 'omim_gene_reviews_paper_ppp2r1a_truth_only',
    label: 'OMIM/GeneReviews/Paper Truth Terms',
    description:
      'Add the exact source-backed PPP2R1A disease terms that OMIM, GeneReviews, and the 2023 PPP2R1A paper support for Houge-Janssens syndrome 2.',
    sourceNote:
      'OMIM 616362 and GeneReviews NBK580243 support global developmental delay, language delay, delayed walking/motor delay, hypotonia, feeding difficulties, seizures, microcephaly, attention-deficit/hyperactivity disorder, short stature, and corpus callosum hypo-/aplasia for PPP2R1A-related NDD. PMID:37761890 supports microcephaly plus feeding problems in the Arg258 group and reviews the broader phenotype across reported PPP2R1A patients.',
    diseaseTerms: {
      'MONDO:0014605': [
...
function renderMarkdownReport(report) {
  const lines = [];
  lines.push('# PPP2R1A Truth Source Shadow');
  lines.push('');
