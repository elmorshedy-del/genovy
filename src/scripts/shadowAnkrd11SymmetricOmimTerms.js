...
const DEFAULTS = Object.freeze({
  ...
  outputJson:
    '/Users/ahmedelmorshedy/Genovy-phenotype-enrichment-20260316-0914/output/shadow-ankrd11-symmetric-omim-terms-20260326.json',
  outputMd:
    '/Users/ahmedelmorshedy/Genovy-phenotype-enrichment-20260316-0914/output/shadow-ankrd11-symmetric-omim-terms-20260326.md',
  limit: 2000
});
...
const SCENARIOS = Object.freeze([
  {
    id: 'omim_literal_structural',
    label: 'OMIM Literal Structural Terms',
    description:
    ...
    sourceNote:
      'KBG syndrome gains short metacarpal; the GDF5 brachydactyly branch gains short middle phalanx of finger plus short metacarpal.',
    diseaseTerms: {
      'MONDO:0007846': ['HP:0010049'],
      'MONDO:0007215': ['HP:0005819', 'HP:0010049']
    }
  },
  {
    id: 'omim_cumulative_with_prior',
    label: 'OMIM Cumulative With Prior Source Shadow',
    description:
    ...
    sourceNote:
      'KBG syndrome gains brachydactyly, focal-onset seizure, abnormality of the hand, and short metacarpal; ETL8 keeps focal-onset seizure; the hand-focused GDF5 branch gains abnormality of the hand, short middle phalanx of finger, and short metacarpal.',
    diseaseTerms: {
      'MONDO:0007846': ['HP:0001156', 'HP:0007359', 'HP:0001155', 'HP:0010049'],
      'MONDO:0014650': ['HP:0007359'],
      'MONDO:0007215': ['HP:0001155', 'HP:0005819', 'HP:0010049']
    }
  }
]);
  ...
  for (const [diseaseCurie, targetTerms] of Object.entries(scenario.diseaseTerms)) {
    ...
    for (const candidateCurie of targetTerms) {
      ...
      shadowAddedTerms.push({
        ...
        reference_text: `[shadow ${scenario.id}] symmetric OMIM-backed augmentation`,
        evidence_code: '',
        onset_curie: '',
        onset_label: '',
        frequency_curie: '',
