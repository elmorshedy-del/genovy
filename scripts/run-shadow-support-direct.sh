...
RUN_NAME="${1:-shadow-support-direct-$(date +%Y%m%d-%H%M%S)}"
...
echo "Running shadow support-direct preference benchmark..."
...
if (( WORKER_COUNT == 1 )); then
  "$NODE_BIN" "$ROOT_DIR/src/scripts/shadowSupportDirectPreference.js" \
